...
from core import base_template as tplm
...
class ECLCalculationInputs:
    ...
    template_data: tplm.TemplateData
...
class BaseECLCalculator(ABC):
    ...
    def calculate_ecl(self, inputs: ECLCalculationInputs) -> ECLCalculationResults:
        ...
        4. Get scenarios based on PD templates
        5. Determine PD values
        6. Determine LGD values
        7. Determine CCF values
        8. Calculate final ECL
